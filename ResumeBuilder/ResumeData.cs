...
namespace ResumeBuilder
{
    public class ResumeData
    {
        ...
        public TextBox txtLink { get; private set; }
        public PictureBox profilePicture { get; private set; }
        public Button btnSelectImage { get; private set; }
        public TextBox txtSummary { get; private set; }
        public TextBox txtEducation { get; private set; }
        public TextBox txtExperience { get; private set; }
        public TextBox txtSkills { get; private set; }
        public TextBox txtLanguages { get; private set; }
        public TextBox txtCertifications { get; private set; }
        public TextBox txtProjects { get; private set; }
        public Button btnGenerate { get; private set; }
        public RichTextBox previewBox { get; private set; }

        private Panel inputPanel;

        public ResumeData(Panel container, RichTextBox previewBox)
        {
        ...
        private void SetupUI()
        {
            ...
            inputPanel.Controls.AddRange(new Control[] {
                lblPersonalInfo, lblName, txtName,
                lblEmail, txtEmail,
                lblPhone, txtPhone,
                lblAddress, txtAddress,
                lblLink, txtLink,
                lblProfilePic, profilePicture, btnSelectImage,
        ...
        private void UpdatePreview(object sender, EventArgs e)
        {
            ...
            AddSection("SUMMARY", txtSummary.Text);
            AddSection("SKILLS AND PROFICIENCIES", txtSkills.Text, true);
            AddSection("LANGUAGES", txtLanguages.Text);
            AddSection("EDUCATION", txtEducation.Text);
            AddSection("WORK EXPERIENCE", txtExperience.Text);
            AddSection("PROJECTS", txtProjects.Text);
            AddSection("CERTIFICATIONS", txtCertifications.Text);
        }

        private void AddSection(string title, string content, bool bulletPoints = false)
        {
            if (string.IsNullOrWhiteSpace(content)) return;

            previewBox.SelectionFont = new Font("Arial", 12, FontStyle.Bold);
            previewBox.AppendText($"{title}\n");
            previewBox.SelectionFont = new Font("Arial", 10, FontStyle.Regular);
            ...
            if (bulletPoints)
            {
                foreach (string line in content.Split('\n'))
                {
                    ...
                    {
                        previewBox.AppendText($"• {line.Trim()}\n");
                    }
                }
            }
            else
            {
                previewBox.AppendText($"{content}\n");
            }
            previewBox.AppendText("\n");
        }
    ...
    JustificationValues? justification = null)
        ...
        private void AddTooltips()
        {
            ...
            tooltip.SetToolTip(txtLanguages, "List languages you know and proficiency level");
